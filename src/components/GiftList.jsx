...
const giftPrices = {
  ...
  "Vale pizza 🍕": "R$ 100,00",
  "Cafeteira ☕": "R$ 350,00",
  "Lua de mel ✈️": "12 cotas de R$ 100,00",
  "PIX do amor 💸": "R$ 100,00",
  "Netflix 🎬": "R$ 240,00",
  ...
  "Vale date night 🌙": "R$ 250,00",
  "Cota plantas que sobrevivam 🌿": "R$ 150,00",
  "Primeiro boleto juntos 🧾": "R$ 300,00",
  "Caixa de ferramentas do casal 🔧": "R$ 350,00",
  "Kit café da manhã preguiçoso 🥐": "R$ 180,00",
  "Fundo emergencial do delivery 🛵": "R$ 200,00",
}
          ...
          {gifts.map((gift) => {
            ...
            return (
              <button
                ...
                `}
              >
                <div className="absolute top-4 right-4 text-sm text-green-400">
